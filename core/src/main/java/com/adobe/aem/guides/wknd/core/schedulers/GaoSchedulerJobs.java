...
public class GaoSchedulerJobs implements Job {
    private static final Logger LOG = LoggerFactory.getLogger(GaoSchedulerJobs.class);
    ...
    public void execute(JobContext jobContext) {
        LOG.info("\n GaoSchedulerJobs=======> COUNTRY {} : URL {} ", jobContext.getConfiguration().get("country"),
