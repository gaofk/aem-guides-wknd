...
import com.adobe.aem.guides.wknd.core.models.MultiExporter;
...
@Exporters({
        @Exporter(name = "jackson", extensions = "json", selector = "gaojson", options = {
                @ExporterOption(name = "SerializationFeature.WRAP_ROOT_VALUE", value = "true")
        }),
        @Exporter(name = "gaoxml", extensions = "xml", selector = "gaoxml")
})
@Model(adaptables = SlingHttpServletRequest.class, adapters = MultiExporter.class, resourceType = MultiExporterImpl.RESOURCE_TYPE, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@JsonRootName("json-exporter")
@XmlRootElement(name = "xml-exporter")
public class MultiExporterImpl implements MultiExporter {
    static final String RESOURCE_TYPE = "wknd/components/multiexporter";
