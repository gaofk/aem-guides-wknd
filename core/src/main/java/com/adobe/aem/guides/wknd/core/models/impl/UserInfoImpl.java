...
import com.adobe.aem.guides.wknd.core.models.UserInfo;
...
@Model(adaptables = SlingHttpServletRequest.class, adapters = UserInfo.class, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
public class UserInfoImpl implements UserInfo {
    ...
    void init() {
        try {
            // String anonymousID = userManagementService != null ?
            // userManagementService.getAnonymousId() :
            ...
            if (userPropertiesManager != null) {
                ...
                for (String userProperty : userProperties.getPropertyNames()) {
                    LOG.info("\n User Properties {} : {} ", userProperty,
                            userProperties.getProperty(userProperty));
                }
