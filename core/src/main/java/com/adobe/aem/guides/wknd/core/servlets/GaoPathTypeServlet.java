...
// http://localhost:4502/bin/test/wkndpages
/* http://localhost:4502/gaowknd/wkndpages
 * Should add gaowknd in your Servlet ConfigMgr
 */
@Component(service = Servlet.class)
@SlingServletPaths(value = { "/bin/test/wkndpages", "/gaowknd/wkndpages" })
public class GaoPathTypeServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(GaoPathTypeServlet.class);
