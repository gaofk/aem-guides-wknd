...
public class GaoJobCreater implements EventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(GaoJobCreater.class);
    ...
    public void handleEvent(final Event event) {
        try {
            ...
            jobProperties.put("demopage", "demoPage");

            Job job = jobManager.addJob("gao/job", jobProperties);
