...
// http://localhost:4502/bin/abc.ds.txt
...
public class GaoServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(GaoServlet.class);
