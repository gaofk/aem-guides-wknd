...
@Configuration(label = "Gao WKND - Context Aware Configuration", description = "Context Aware Configuration for AEM Geeks.")
public @interface GaoWKNDCAConfig {
    ...
    @Property(label = "GAO WKND Site Section", description = "GAO WKND Site section for geeks site.")
