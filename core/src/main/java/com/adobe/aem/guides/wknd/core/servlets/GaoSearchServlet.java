...
public class GaoSearchServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(GaoSearchServlet.class);
    ...
    protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
        ...
        try {
            ...
            // resp.getWriter().write("searchResult:" + pageNumber.toString() + ":" +
            // resultPerPage.toString());
            searchResult = searchService.searchResult(searchtext, startResult,
                    resultPerPage);
        } catch (Exception e) {
            LOG.info("\n ERROR {} ", e.getMessage());
        }
